...
namespace Otlob {
	...
	/// <summary>
	/// Summary for AllOffers
	/// </summary>
	public ref class AllOffers : public System::Windows::Forms::Form
	{
	public:
		AllOffers(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(AllOffers::typeid));
			...
			this->bunifuImageButton1->Click += gcnew System::EventHandler(this, &AllOffers::bunifuImageButton1_Click);
			// 
			// panel1
			// 
			...
			this->Name = L"AllOffers";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"AllOffers";
