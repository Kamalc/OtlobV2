...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_SignUp->Size = System::Drawing::Size(185, 50);
			...
			this->button_Minimize->Click += gcnew System::EventHandler(this, &SignUp::button_Minimize_Click);
			// 
			// panel2
			// 
			...
			this->pictureBox1->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseDown);
			this->pictureBox1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseMove);
			this->pictureBox1->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseUp);
			// 
			// button_AdminRoom
			// 
			...
			this->button_AdminRoom->Click += gcnew System::EventHandler(this, &SignUp::button_AdminRoom_Click);
			// 
			// button_Home
			// 
			...
			this->button_MyBills->Click += gcnew System::EventHandler(this, &SignUp::button_MyBills_Click);
			// 
			// button_AllOffers
			// 
...
//			this->button_AllOffers->Click += gcnew System::EventHandler(this, &SignUp::button_AllOffers_Click);
			// 
			// button_AllFoods
			// 
			...
			//this->button_AllFoods->Click += gcnew System::EventHandler(this, &SignUp::button_AllFoods_Click);
			// 
			...
			//this->button_AllRestuarants->Click += gcnew System::EventHandler(this, &SignUp::button_AllRestuarants_Click);
			// 
			// label2
			// 
			...
			this->label2->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseDown);
			this->label2->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseMove);
			this->label2->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &SignUp::Panel_Header_MouseUp);
			// 
			// SignUp
			// 
...
private: System::Void button_SubmitSU_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	Customer^ newCustomer = gcnew Customer(bunifuMaterialTextbox1->Text, Textbox_Password->Text, textBox_Email->Text, Convert::ToString(bunifuDatepicker1->Value.Day), Convert::ToString(bunifuDatepicker1->Value.Month), Convert::ToString(bunifuDatepicker1->Value.Year), textBox_FirstName->Text, textBox_LastName->Text, textBox_Phone->Text);
