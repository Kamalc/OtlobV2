...
namespace Otlob {
	...
	/// <summary>
	/// Summary for AllRestaurants
	/// </summary>
	public ref class AllRestaurants : public System::Windows::Forms::Form
	{
	public:
		AllRestaurants(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(AllRestaurants::typeid));
			...
			this->bunifuImageButton1->Click += gcnew System::EventHandler(this, &AllRestaurants::bunifuImageButton1_Click);
			// 
			...
			this->Name = L"AllRestaurants";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"AllRestaurants";
